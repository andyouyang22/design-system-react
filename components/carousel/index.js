...
function (_React$Component) {
  ...
  function Carousel(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onIndicatorFocus", function () {
      _this.setState({
        indicatorsHaveFocus: true
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "startAutoplay", function () {
      _this.autoplayId = setInterval(function () {
        if (_this.canGoToNext()) {
          ...
          _this.setCurrentPanel(1, _this.changeTranslationAutomatically);
        }
  ...
  _createClass(Carousel, [{
    ...
    value: function componentWillMount() {
      ...
      (0, _checkProps.default)(_constants.CAROUSEL, _docs.default);
    }
  }, {
