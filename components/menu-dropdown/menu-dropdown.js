...
function (_React$Component) {
  ...
  function MenuDropdown() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderDefaultMenuContent", function (customListProps) {
      return _react.default.createElement(_menuList.default, _extends({
    ...
    _defineProperty(_assertThisInitialized(_this), "renderMenuContent", function (customContent) {
      ...
      _react.default.Children.forEach(customContent, function (child) {
        if (child && child.type.displayName === _constants.LIST) {
          ...
          var clonedCustomContent = _react.default.cloneElement(child, {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderDialog", function (customContent, isOpen, outsideClickIgnoreClass) {
      ...
      return isOpen ? _react.default.createElement(_dialog.default, {
        ...
        closeOnTabKey: true,
        contentsClassName: (0, _classnames.default)('slds-dropdown', "slds-dropdown_".concat(_this.props.width), 'ignore-react-onclickoutside', _this.props.className, positionClassName),
  ...
  _createClass(MenuDropdown, [{
    ...
    value: function componentWillMount() {
      ...
      (0, _checkProps.default)(_constants.MENU_DROPDOWN, this.props, _docs.default);
    ...
    value: function render() {
      ...
      */
      ...
      return _react.default.createElement(CurrentTrigger, _extends({
        "aria-haspopup": true,
