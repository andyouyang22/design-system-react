define(['exports', 'react', 'prop-types', '../utilities/dialog', './private/calendar-wrapper', '../icon/input-icon', '../forms/input', 'lodash.assign', 'airbnb-prop-types', 'lodash.isboolean', 'classnames', 'shortid', './check-props', '../../utilities/event', '../../utilities/key-code', '../../utilities/constants'], function (exports, _react, _propTypes, _dialog, _calendarWrapper, _inputIcon, _input, _lodash, _airbnbPropTypes, _lodash3, _classnames, _shortid, _checkProps, _event, _keyCode, _constants) {
	'use strict';
  ...
  */
   ...
   */
		...
		/**
   * True if users can type dates into the input directly. This allows users to type dates, clear
   * dates, and specify multiple dates. Clicking on the input no longer opens the calendar component
   */
		isInputEditable: _propTypes2.default.bool,
		/**
  ...
  */
	...
	var Datepicker = function (_React$Component) {
		...
		_createClass(Datepicker, [{
			...
			value: function handleCalendarChange(event, _ref) {
				var date = _ref.date;
			...
			key: 'handleOpen',
			value: function handleOpen(event, _ref2) {
			...
			key: 'getDatePicker',
			value: function getDatePicker(_ref4) {
				var _this3 = this;

				var labels = _ref4.labels,
				    assistiveText = _ref4.assistiveText;
				...
				return _react2.default.createElement(_calendarWrapper2.default, {
					...
					selectedDateRef: function selectedDateRef(component) {
						_this3.selectedDateCell = component;
					},
			...
			value: function render() {
				...
				var clonedInputProps = {
					...
					onClick: function onClick() {
						if (!_this4.props.isInputEditable) {
							_this4.openDialog();
						}
